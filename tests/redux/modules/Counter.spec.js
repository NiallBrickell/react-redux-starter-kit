import { COUNTER_INCREMENT, increment, doubleAsync, default as counterReducer } from 'redux/modules/Counter';
...
describe('(Redux Module) Counter', () => {
	...
	describe('(Action Creator) doubleAsync', () => {
		...
		it('Should return a promise from that thunk that gets fulfilled.', () => {
			return doubleAsync()({dispatch: _dispatchSpy, getState: _getStateSpy}).should.eventually.be.fulfilled;
		});

		it('Should call dispatch and getState exactly once.', () => {
			return doubleAsync()({dispatch: _dispatchSpy, getState: _getStateSpy})
				.then(() => {
